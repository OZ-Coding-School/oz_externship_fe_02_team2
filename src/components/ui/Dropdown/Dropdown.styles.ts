...
export const MENU_BASE = cn(
  ...
  'rounded-lg border border-gray-300 bg-gray-100 shadow-lg'
)
export const menuAlignClass = (align: 'start' | 'end' = 'start') =>
  cn(align === 'end' ? 'right-0' : 'left-0')

export const OPTION_BASE = cn(
  'cursor-pointer select-none px-3 py-2 body-sm text-[#000000]'
)
export const OPTION_ACTIVE = cn('bg-gray-200')
export const OPTION_SELECTED = cn('font-medium bg-gray-300')
