...
const DUMMY_REVIEWS: Review[] = [
  {
    ...
    content: '정말 알찬 스터디였습니다! 리더님이 커리큘럼을 짜주셔서 단계적으로 학습할 수 있었고, 팀 프로젝트를 통해 실무 경험도 쌓을 수 있었어요. 특히 코드 리뷰 시간이 많은 도움이 되었습니다. 다른 분들께도 강력 추천합니다!',
  ...
  },
  {
    ...
    content: '처음에는 Django가 어려워 보였는데, 스터디원들과 함께 차근차근 배워나가니 금세 익숙해졌어요. 서로 질문하고 답변하며 성장하는 분위기가 좋았습니다.',
  ...
  },
  {
    ...
    content: '비전공자인데도 차근차근 설명해주셔서 이해하기 쉬웠어요. 실제 업무 데이터로 분석 실습을 할 수 있어 더욱 유익했습니다.',
  ...
  },
  {
    ...
    content: '이미 React를 어느 정도 알고 있는 상태에서 참여했는데, 고급 기술들과 모범 사례들을 배울 수 있어 좋았습니다. 팀 프로젝트를 통해 실무 경험도 쌓을 수 있었어요.',
  ...
  },
  {
    ...
    content: 'JavaScript로 백엔드를 개발하는 것이 이렇게 재미있을 줄 몰랐어요! Express를 이용한 RESTful API 구축에 대한 강의가 특히 인상적이었습니다.',
  ...
  },
  {
    ...
    content: '처음 모바일 개발을 시작하는 입장에서 Flutter는 정말 좋은 선택이었어요. 한 번의 코드로 iOS, Android 앱을 모두 만들 수 있다는 것이 가장 큰 장점입니다.',
  ...
  },
  {
    ...
    content: '프로그래밍을 처음 배우는 입장에서도 따라갈 수 있도록 친절하게 설명해주셨어요. 처음엔 어려웠지만, 꾸준히 복습하면서 실력이 늘어가는 것을 느꼈습니다.',
  ...
  },
  {
    ...
    content: 'AI/ML 분야의 최신 동향과 실무 기술을 배울 수 있어서 좋았습니다. 이론과 실습의 균형이 잘 잡혀 있었고, 강사님의 풍부한 경험을 들을 수 있었던 것도 큰 도움이 되었습니다.',
      ...
      <div className="overflow-hidden rounded-lg bg-white shadow-md">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th className="w-24 px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500"># ID</th>
              <th className="w-56 px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">스터디 그룹명</th>
              <th className="w-56 px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">작성자 정보</th>
              <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">리뷰 내용</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200 bg-white">
            {filteredReviews.length > 0 ? (
              filteredReviews.map((review) => (
                ...
                >
                  <td className="whitespace-nowrap px-6 py-4 text-xs text-gray-900">{`#${review.id}`}</td>
                  <td className="whitespace-nowrap px-6 py-4 text-xs text-gray-900">{review.studyName}</td>
                  <td className="whitespace-nowrap px-6 py-4 text-xs text-gray-900">
                    <div className="flex flex-col">
                      <span className="font-medium text-gray-900">{review.reviewerInfo.nickname}</span>
                      <span className="text-gray-500">{review.reviewerInfo.email}</span>
                    </div>
                  </td>
              ...
              <tr>
                <td colSpan={4} className="px-6 py-4 text-center text-gray-500">
                  {searchTerm ? '검색 결과가 없습니다.' : '표시할 리뷰 데이터가 없습니다.'}
                </td>
              </tr>
            )}
          </tbody>
